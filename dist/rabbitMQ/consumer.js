...
exports.createConsumer = exports.connectChannel = void 0;
    ...
    if (!queueConsumerStarted.has(queueKey)) {
        ...
        await channel.consume(queue, async (msg) => {
            if (!msg)
                return;
            try {
                const parentContext = api_1.propagation.extract(api_1.context.active(), msg.properties.headers);
                ...
                await api_1.context.with(parentContext, async () => {
